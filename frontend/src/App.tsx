...
const ProtectedRoute = ({ children, allowedRole }: { children: React.ReactNode; allowedRole: string }) => {
  ...
  if (allowedRole === 'user' && role !== 'user' && role !== 'mahasiswa') return <Navigate to="/login" replace />;
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/admin/add-materi" element={<ProtectedRoute allowedRole="admin"><AddMateriAdmin /></ProtectedRoute>} />
        <Route path="/admin/buat-kursus" element={<ProtectedRoute allowedRole="admin"><BuatKursus /></ProtectedRoute>} />
